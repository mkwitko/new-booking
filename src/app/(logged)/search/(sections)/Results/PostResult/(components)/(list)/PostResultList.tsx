  ...
  return (
    <div className="flex w-full items-center rounded-b2b bg-white p-4">
      <div className="flex w-full flex-col">
        <div className="flex w-full flex-col items-center justify-between gap-4 border-b px-4 pb-4 md:flex-row md:gap-0">
          ...
          <div className="flex w-full flex-col gap-4 md:w-3/4">
            ...
            <div className="my-2 flex w-full flex-row items-start justify-center md:justify-start">
              {hotel.roomTypes[0].availability && (
                <div className="flex w-full flex-col items-center justify-between gap-4 sm:flex-row sm:justify-start">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-small font-[300] capitalize text-textPrimary md:text-normal">
                      {hotel.roomTypes[0].description.toLowerCase()}
                    </p>
                  </div>
                  <div className="flex flex-wrap items-end justify-center divide-x md:items-center">
