...
export function ReserveForm() {
  ...
  const { customer, card, hotels } = useContext(LoggedContext);
        ...
        >
            ...
            <div className="mt-6 grid w-full grid-cols-1 gap-4 lg:grid-cols-2">
              <div className="mt-auto w-full">
                ...
                <FormComponents.Select.Root
                  onValueChange={handleChangePurchaseName}
                  placeholder="Selecione um cliente"
                >
                  {customer.hook.data &&
                    customer.hook.data.map((item: any) => {
                      return (
          ...
          <WhiteBox classes="gap-0 lg:gap-0">
            ...
            <div className="mt-6 grid w-full grid-cols-1 gap-4 lg:grid-cols-2">
              ...
              >
                {currentHotel &&
                  currentHotel.billings &&
                  currentHotel.billings.map(
